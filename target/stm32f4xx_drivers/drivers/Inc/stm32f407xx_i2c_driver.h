...
/*
 * This is a Configuration structure for a I2Cx (Inter Integrated Circuit x) peripheral
 */
typedef struct
{
...
/*
 * This is a Handle structure for a I2Cx (Inter Integrated Circuit x) peripheral
 */
typedef struct
{
	I2C_RegDef_t 	*pI2Cx;			/* This holds the base address of the I2Cx(x:1,2,3) Peripheral */
